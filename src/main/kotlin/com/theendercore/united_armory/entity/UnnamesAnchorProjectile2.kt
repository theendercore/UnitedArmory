...
open class UnnamesAnchorProjectile2 : AbstractArrow, ItemSupplier {
    constructor(entityType: EntityType<out UnnamesAnchorProjectile2>, level: Level) : super(entityType, level)
    constructor(level: Level, owner: LivingEntity, weapon: ItemStack) : super(UAEntityTypes.UNNAMES_ANCHOR2, level) {
        setOwner(owner)
    ...
    companion object {
        val WEAPON_DATA: EntityDataAccessor<ItemStack> =
            SynchedEntityData.defineId(UnnamesAnchorProjectile2::class.java, EntityDataSerializers.ITEM_STACK)
        val RETURNING_DATA: EntityDataAccessor<Boolean> =
            SynchedEntityData.defineId(UnnamesAnchorProjectile2::class.java, EntityDataSerializers.BOOLEAN)
    }
}
