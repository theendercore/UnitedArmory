...
object UADataAttachments {
    ...
    @JvmField
    val PHANTASM_ATTACHMENT: AttachmentType<Boolean> = AttachmentRegistry.create<Boolean>(id("iframe_effect")) {
        it.persistent(Codec.BOOL).syncWith(ByteBufCodecs.BOOL, syncAllPredicate())
    }
}